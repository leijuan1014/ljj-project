...
public class QRCodeUtil
{
    ...
    public void qrcode(String url, String mobile, HttpServletRequest request, HttpServletResponse response) throws IOException {
    	BufferedImage image = getLogoQRCode("https://www.baidu.com/", "跳转到百度的二维码", request);
    ...
    public static void main(String[] args) throws WriterException  
    {
        ...
        try  
        {  
            //getLogoQRCode("https://www.baidu.com/", "跳转到百度的二维码", null);
        		QRCodeUtil zp = new QRCodeUtil();
            BufferedImage bim = zp.getQR_CODEBufferedImage("https://www.baidu.com/", BarcodeFormat.QR_CODE, 400, 400, zp.getDecodeHintType());
     ...
     * @param logoPic
     */
    public static BufferedImage getLogoQRCode(String qrUrl,String productName, HttpServletRequest request)
    {
      String filePath = request.getSession().getServletContext().getRealPath("/") + "img/logo.png";
     ...
     * @param logoPic
     */
    public BufferedImage addLogo_QRCode(BufferedImage bim, File logoPic, LogoConfig logoConfig, String productName)
    {
        try
        {
            /**
...
//                  outg.drawString(productName, 0, image.getHeight() + (outImage.getHeight() - image.getHeight())/2 + 5 ); //画文字
            ...
            //ImageIO.write(image, "png", new File("/Users/xiss/Documents/project/xissdoc/logo/TDC-" + new Date().getTime() + "test.png")); //TODO  
