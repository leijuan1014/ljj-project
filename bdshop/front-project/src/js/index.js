define(["components", "common", "template"], function (components, common, template) {
    ...
    var apiUrl = "http://localhost:8080/dbshop";
    //"http://192.168.1.103:8080/xiss",//"https://api.autoxss.com/xisstest",//"http://www.ljjzwh.com:90/xiss", //配置全局api请求域名
    var apiUrlPic = "http://192.168.1.103:90/images/bdshop";
    //"https:///api.autoxss.com/images/bdshop";//"http:///www.ljjzwh.com:90/pages/bdshop/upload";//"http://192.168.1.103:90/img/bdshop";
    ...
    function getTest() {
        $.ajax({
            ...
            url:"http://192.168.1.103:8080/bdshop/jsp/controller.jsp?action=uploadimage&enco…lastModifiedDate=Wed+Aug+02+2017+09%3A18%3A44+GMT%2B0800+(CST)&size=101274",
            type: 'GET',
            xhrFields: {
    ...
    var goodsList = {
        ...
        url: apiUrl + "/front/goods/goods/getPageFrontRecommendAndIsMarketableGoods", //数据api
