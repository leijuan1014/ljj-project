define(['jquery', "template", "components", "ZeroClipboard", "jqueryValidate", "ueditorConfig", "ueditorAll", "manageCommon","bootstrap"],function(jquery, template, components, ZeroClipboard, validator, ueditorConfig, ueditorAll, manageCommon,bootstrap) {
  //console.log('UE', UE);
    getModules();
    function getModules() {
        var flag1 = false;
