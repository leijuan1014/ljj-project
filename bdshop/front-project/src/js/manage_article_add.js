define(['jquery', "template", "components", "ZeroClipboard", "jqueryValidate", "ueditorConfig", "ueditorAll", "manageCommon"], function(jquery, template, components, ZeroClipboard, validator, ueditorConfig, ueditorAll, manageCommon) {
    getModules();
    function getModules() {
        var flag1 = false;
        var flag2 = false;
        ...
        $("#div-box").on("change", "#pic-upload", function() {
            ...
            $.ajax({
                ...
                success: function(msg) {
                    var picListHtml = '<li picUrl="' + msg.imageUrl + '"class="apply-book"> <img  src=" ' + apiUrlPic + msg.imageUrl + '"> <a docUrl="' + msg.imageUrl + '" href="javascript:void(0)" class="text-basic del-doc iconfont icon-close"></a></li>';
