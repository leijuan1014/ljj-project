...
//定义部署路径
var dist = './bdshop', replacePath = '/pages/bdshop/';
//定义包
var pkg = {
    version: "1.0.0"
};
...
gulp.task('htmlmin', function() {
    return gulp.src('./page/*.html')
        .pipe(replace('/src/', replacePath))
        .pipe(replace('/index.html', replacePath + 'index.html'))
        .pipe(replace('/css/manage.css', replacePath + 'css/manage.css'))
        .pipe(replace('/css/style.css', replacePath + 'css/style.css'))
        .pipe(replace('/css/index.css', replacePath + 'css/index.css'))
        .pipe(replace('/css/bundle.css', replacePath + 'css/bundle.css'))
        .pipe(replace('/page/', replacePath + 'page/'))
        .pipe(htmlreplace({
            'css': '/css/bundle.css'
        }))
...
gulp.task('deploy', function() {
    gulp.start('index', 'css', 'htmlmin', 'js', 'img', 'font', 'libs');
});
