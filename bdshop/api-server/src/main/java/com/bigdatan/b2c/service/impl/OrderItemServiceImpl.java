...
@Service
public class OrderItemServiceImpl extends BaseServiceImpl<Order> implements IOrderItemService {
	private Logger lo = Logger.getLogger(OrderItemServiceImpl.class);
	@Resource
