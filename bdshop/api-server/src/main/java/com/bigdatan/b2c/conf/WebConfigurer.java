...
public class WebConfigurer extends WebMvcConfigurerAdapter {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        //registry.addInterceptor(new QqWebInterceptor()).addPathPatterns("/front/*/**").excludePathPatterns("/front/user/user/checkCode").excludePathPatterns("/front/user/user/sendCode");
