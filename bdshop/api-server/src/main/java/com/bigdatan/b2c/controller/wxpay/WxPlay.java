...
import com.bigdatan.b2c.pay.Configure;
import com.bigdatan.b2c.pay.Signature;
import com.bigdatan.b2c.pay.Util;
import com.bigdatan.b2c.pay.WxPlaceOrder;
import com.bigdatan.b2c.pay.XMLParser;
...
public class WxPlay extends AbstractController {
    ...
    public Map<String, Object> pay(HttpServletRequest request,
        ...
        wxPlaceOrder.setAppid(account.getAppId());
        wxPlaceOrder.setBody("购买商品");
        wxPlaceOrder.setMch_id(account.getMerchantId());
