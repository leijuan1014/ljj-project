...
CREATE TABLE t_admin (
  ...
  admin_name  character varying DEFAULT NULL,
  password  character varying DEFAULT '',
  rand  character varying DEFAULT '',
  company_name  character varying,
  description  character varying DEFAULT '',
  state integer DEFAULT '1',
  create_time timestamp without time zone NOT NULL DEFAULT NULL,
  update_time timestamp without time zone NOT NULL DEFAULT NULL,
  del_state integer DEFAULT '2',
  creat_id integer DEFAULT NULL,
...
CREATE TABLE t_ad_position (
  ad_position_id integer NOT NULL,
  name  character varying DEFAULT NULL,
  position  character varying DEFAULT NULL,
  measure  character varying DEFAULT NULL,
  state integer DEFAULT '1',
  create_time timestamp without time zone NOT NULL DEFAULT NULL,
  update_time timestamp without time zone NOT NULL DEFAULT NULL,
  admin_id integer DEFAULT NULL,
...
CREATE TABLE t_article (
  ...
  content text,
  key_words  character varying DEFAULT NULL,
  author  character varying DEFAULT NULL,
  publishTime timestamp without time zone NOT NULL DEFAULT NULL,
  publisher  character varying DEFAULT NULL,
  recommend integer DEFAULT '2',
  is_published integer DEFAULT '0',
  state integer DEFAULT NULL,
  is_top integer DEFAULT '0',
  image  character varying DEFAULT NULL,
  create_time timestamp without time zone NOT NULL DEFAULT NULL,
  update_time timestamp without time zone NOT NULL DEFAULT NULL,
  del_state integer DEFAULT '2',
  admin_id integer DEFAULT NULL,
...
CREATE TABLE t_goods (
  ...
  category_id integer DEFAULT NULL,
  goods_name  character varying DEFAULT '',
  nickname  character varying DEFAULT NULL,
  image  character varying DEFAULT '',
  del_state integer DEFAULT '2',
  simple_describe  character varying DEFAULT '',
  detail_describe text,
  is_marketable integer DEFAULT '0',
  recommend integer DEFAULT '2',
  create_time timestamp without time zone NOT NULL DEFAULT NULL,
  update_time timestamp without time zone NOT NULL DEFAULT NULL,
  admin_id integer DEFAULT NULL,
...
CREATE TABLE t_goods_category (
  ...
  category_name  character varying DEFAULT NULL,
  image  character varying DEFAULT NULL,
  state integer DEFAULT '2',
  simple_describe  character varying DEFAULT NULL,
  recommend integer DEFAULT '2',
  create_time timestamp without time zone NOT NULL DEFAULT NULL,
  update_time timestamp without time zone NOT NULL DEFAULT NULL,
  admin_id integer DEFAULT NULL,
...
CREATE TABLE t_goods_price (
  ...
  goods_id integer DEFAULT NULL,
  unit_name  character varying DEFAULT NULL,
  retail_price integer DEFAULT NULL,
...
CREATE TABLE t_message (
  ...
  message_title  character varying DEFAULT NULL,
  message_short_context  character varying DEFAULT NULL,
  message_context text,
  url  character varying DEFAULT NULL,
  push_time timestamp without time zone NOT NULL DEFAULT NULL,
  push integer DEFAULT NULL,
  push_now integer DEFAULT NULL,
  is_all integer DEFAULT NULL,
  user_ids text,
  create_time timestamp without time zone NOT NULL DEFAULT NULL,
  update_time timestamp without time zone NOT NULL DEFAULT NULL,
  del_state integer DEFAULT '2',
...
CREATE TABLE t_order (
  ...
  order_number  character varying DEFAULT '',
  user_id integer DEFAULT NULL,
  ...
  send_time timestamp without time zone NOT NULL DEFAULT NULL,
  logistics_state integer DEFAULT '1',
  invoice_tag integer DEFAULT '0',
  del_state integer DEFAULT '2',
  payment_id integer DEFAULT NULL,
  payment_seq  character varying DEFAULT NULL,
  pay_state integer DEFAULT '1',
...
CREATE TABLE t_order_certify (
  certify_id integer NOT NULL,
  order_id integer DEFAULT NULL,
  order_number  character varying DEFAULT NULL,
  image_url  character varying DEFAULT NULL,
  create_time timestamp without time zone NOT NULL DEFAULT NULL,
  update_time timestamp without time zone NOT NULL DEFAULT NULL,
  admin_id integer DEFAULT NULL,
...
CREATE TABLE t_order_details (
  ...
  details_amount integer DEFAULT NULL,
  create_time timestamp without time zone NOT NULL DEFAULT NULL,
  image  character varying DEFAULT '',
...
CREATE TABLE t_order_join (
  join_order_id integer NOT NULL,
  join_order_number  character varying DEFAULT NULL,
  order_ids  character varying DEFAULT NUL,
  order_numbers text,
...
CREATE TABLE t_privilege (
  ...
  user_id integer DEFAULT NULL,
  is_wholeSalePrice integer DEFAULT '0',
  isDiscount integer DEFAULT NULL,
...
CREATE TABLE t_user (
  ...
  openid  character varying DEFAULT '',
  nickname  character varying DEFAULT '',
  headimgurl  character varying DEFAULT '',
  sex  character varying DEFAULT '',
  phone  character varying DEFAULT '',
  province  character varying DEFAULT '',
...
CREATE TABLE t_user_receive (
  ...
  user_id integer DEFAULT NULL,
  contact  character varying DEFAULT '',
  tel  character varying DEFAULT '',
  receive_province  character varying DEFAULT '',
  receive_city  character varying DEFAULT '',
  receive_county  character varying DEFAULT '',
  receive_address  character varying DEFAULT '',
  create_time timestamp without time zone NOT NULL DEFAULT NULL,
  update_time timestamp without time zone NOT NULL DEFAULT NULL,
