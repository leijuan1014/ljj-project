...
public class WxpayPlaceOrder extends WxpayStep{
	...
	public WxpayPlaceOrderResult run() {
	...
	public WxpayPlaceOrderResult run1() {
		
		//使用优惠券 TODO
		InputStream resultIS = postRun("https://api.mch.weixin.qq.com/pay/unifiedorder");
		WxpayPlaceOrderResult result = (WxpayPlaceOrderResult) decodeResponse(resultIS);
		System.out.println("======WxpayPlaceOrderResult=" + result);
        return result;
	}
